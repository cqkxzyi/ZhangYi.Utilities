...
namespace DotNet.zy.Utilities
{
    ...
    public class CompressPicHelper
    {
        ...
        #region 获取ImageCodecInfo对象，代表的JPEG编解码器。
        /// <summary>
        /// 获取ImageCodecInfo对象，代表的JPEG编解码器。
        /// </summary>
        ...
        #region 将图片压缩到指定尺寸的图片
        /// <summary>
        /// 将图片压缩到指定尺寸的图片
        /// </summary>
        /// <param name="strSrcFile">原文件</param>
        /// <param name="strTargetFile">新文件</param>
        /// <param name="Width">生成图片宽度</param>
        /// <param name="Height">生成图片高度</param>
        /// <returns></returns>
        public static bool CompressPic(string strSrcFile, string strTargetFile, int Width, int Height)
        {
            try
            {
                Image img = Image.FromFile(strSrcFile);
                ...
                string strFileExtension = Path.GetExtension(strSrcFile).ToLower();
                ...
                outBmp.Save(strTargetFile, GetImageCodecInfo(mimeType), encoderParams);
                outBmp.Dispose();
                return true;
            }
            catch
            ...
            else
            {
                ...
                if (0 <= dRate - dMaxRate)
                {
                    if (initImage.Width > targetWidth)
                    {
                        ...
                        newHeight = ConvertHelper.CastInt(Math.Floor(targetWidth / dRate));
                    }
                }
                else
                {
                    ...
                    {
                        newWidth = ConvertHelper.CastInt(Math.Floor(targetHeight * dRate));
        ...
        #region 获取指定mimeType的ImageCodecInfo
        /// <summary>

...
namespace System
{
    ...
    {
        /// <summary>
        /// 对字符串进行编码，同时使 HTML、JavaScript、Style 标签失效
        /// </summary>
        ...
        {
            var array = System.Text.Encoding.Default.GetBytes(c);
        ...
        private static String GetRandomResult(int length, IList<Char> sourcestr)
        {
            ...
            var ran = new Random(DateTime.Now.Millisecond + length - sourcestr.GetHashCode());

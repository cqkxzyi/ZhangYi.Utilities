...
namespace DotNet.zy.Utilities
{
    ...
    public class ZipHelper3
    {
        ...
        #region 压缩目录 private static bool ZipFileDictory(string FolderToZip, string ZipedFile, int level)
        /// <summary>
        /// 压缩目录
        /// </summary>
        /// <param name="FolderToZip">待压缩的文件夹，全路径格式</param>
        ...
        #region 压缩文件 private static bool ZipFile(string FileToZip, string ZipedFile, int level)
        /// <summary>
        /// 压缩文件
        /// </summary>
        /// <param name="FileToZip">要进行压缩的文件名</param>

...
namespace MvcObject.通用
{
    ...
    public class RabbitMQConsumerHelper
    {
        ...
        public static void 接收Direct交换机()
        {
            string queue_name = "queue_All";
            ...
            channel.QueueDeclare(queue_name, true, false, false, null);//声明消息队列
            channel.ExchangeDeclare(exchange_name, exchangeType, true, false, null); //声明交换机
            channel.QueueBind(queue_name, exchange_name, routingkey, null);//绑定关系
        ...
        public static void 接收Fanout交换机() //相当于广播
        {
            string queue_name = "queue_All";
        ...
        {
            string queue_name = "queue_jiaohuan";
            string exchange_name = "exchange_zhangyi";

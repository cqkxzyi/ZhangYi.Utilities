...
namespace DotNet.zy.Utilities
{
    ...
    {
        public static string connString = DotNet.zy.Utilities.SqlHelper.ConnectionString;
        ...
        {
            return SqlHelper3.ExecuteDataset(connString, CommandType.Text, sql, para).Tables[0];
        }
        ...
        {
            return SqlHelper3.ExecuteNonQuery(connString, CommandType.Text, sql, para);
        }
        ...
        {
            return SqlHelper3.ExecuteScalar(connString, CommandType.Text, sql, para);
        }
        ...
        {
            return SqlHelper3.ExecuteReader(connString, CommandType.Text, sql, para);
        }

        public static SqlDataReader ExecuteDataReader(string sql)
        {
            return SqlHelper3.ExecuteReader(connString, CommandType.Text, sql);
        }
        ...
        {
            return SqlHelper3.ExecuteString(connString, CommandType.StoredProcedure, procedureName, paramenterName, para);
        }

        public static DataTable ExecuteProcedure(string connectionString, string procedureName, params SqlParameter[] para)
        {
            return SqlHelper3.ExecuteDataset(connectionString, CommandType.StoredProcedure, procedureName, para).Tables[0];
        }

        public static string ExecuteString(string connectionString, string procedureName, int index, params SqlParameter[] para)
        {
            return SqlHelper3.ExecuteString(connectionString, CommandType.StoredProcedure, procedureName, index, para);
        }
        ...
        {
            return SqlHelper3.ExcuteTran(connString, CommandType.Text, commandText);
        }

        public static int ExecuteTran(string commandText, params SqlParameter[] para)
        {
            return SqlHelper3.ExcuteTran(connString, CommandType.Text, commandText, para);
        }
        ...
        public static DataTable GetDataByPager2000(string fieldlist, string tablename, string where, string orderfield, string key, int pageindex, int pagesize, out int recordcount)
        {
            ...
            DataTable dt = SqlHelper3.ExecuteDataset(connString, CommandType.StoredProcedure, cmd, para).Tables[0];
            recordcount = ConvertHelper.CastInt(para[7].Value);
            return dt;
        }
...
END
     **/
        ...
        public static int GetMaxID(string tableName, string field)
        {
            ...
            int i = Convert.ToInt32(SqlHelper3.ExecuteScalar(connString, CommandType.Text, s) == DBNull.Value ? "0" : SqlHelper3.ExecuteScalar(connString, CommandType.Text, s));
            return i;
        }

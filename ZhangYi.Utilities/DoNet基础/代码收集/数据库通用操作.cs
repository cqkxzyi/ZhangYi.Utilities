...
public class Data
{
   public static string sql = "select * from table";
   public static  SqlConnection SqlConn = new SqlConnection(sql);
    ...
    //通用的查询操作  参数集合
    public static DataTable GetExecute(string sql, params SqlParameter[] ps)
    {
        SqlDataAdapter da = new SqlDataAdapter(sql, SqlConn);
    ...
    public class 连接数据库字符串
    {
            ...
            string strConnection="Provider=Microsoft.Jet.OleDb.4.0;"+@"Data Source=C:\BegASPNET\Northwind.mdb";
